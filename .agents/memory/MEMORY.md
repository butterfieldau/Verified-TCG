...
- [Expo legacy architecture animations](expo-legacy-architecture-animations.md) — SDK 54 legacy iOS builds require Reanimated 3; Reanimated 4 rejects pod installation when New Architecture is off.
