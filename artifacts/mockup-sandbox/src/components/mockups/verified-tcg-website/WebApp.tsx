...
import { 
  ...
  Trophy, ScanLine, CreditCard, Check,
  Settings
} from 'lucide-react';
    ...
    <div className="animate-in fade-in duration-300">
      <div className="flex justify-between items-end mb-8">
        ...
        <div className="flex gap-4">
          <div className="bg-card border border-border rounded-xl px-6 py-3 text-center min-w-[140px]">
            <div className="text-xs font-bold text-muted-foreground mb-1 tracking-wider">TOTAL CARDS</div>
            <div className="font-display text-2xl font-bold">847</div>
          </div>
          <div className="bg-card border border-border rounded-xl px-6 py-3 text-center min-w-[140px]">
            <div className="text-xs font-bold text-muted-foreground mb-1 tracking-wider">TOTAL VALUE</div>
            <div className="font-display text-2xl font-bold text-positive">$24,850</div>
          </div>
          <div className="bg-card border border-border rounded-xl px-6 py-3 text-center min-w-[140px]">
            <div className="text-xs font-bold text-muted-foreground mb-1 tracking-wider">HIGHEST VALUE</div>
            <div className="font-display text-2xl font-bold">$42,000</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-6 mb-8">
        <div className="bg-card border border-border rounded-xl p-6 hover:border-primary/30 transition-colors">
          <div className="flex items-center gap-3 text-muted-foreground mb-3 text-xs font-bold tracking-wider">
            <Layers size={16} /> COLLECTION VALUE
          </div>
          <div className="font-display text-4xl font-bold">$24,850</div>
        </div>
        <div className="bg-card border border-border rounded-xl p-6 hover:border-primary/30 transition-colors">
          <div className="flex items-center gap-3 text-muted-foreground mb-3 text-xs font-bold tracking-wider">
            <Trophy size={16} /> GRADED CARDS
          </div>
          <div className="font-display text-4xl font-bold">142</div>
        </div>
        <div className="bg-card border border-border rounded-xl p-6 hover:border-primary/30 transition-colors">
          <div className="flex items-center gap-3 text-muted-foreground mb-3 text-xs font-bold tracking-wider">
            <ScanLine size={16} /> SUCCESSFUL TRADES
          </div>
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div className="bg-card border border-border rounded-xl p-6">
          ...
          <div className="space-y-6">
            {[
              { id: 'push', label: 'Push Notifications', desc: 'Price alerts and trade offers' },
              { id: 'email', label: 'Email Digest', desc: 'Weekly market summaries' },
              { id: 'public', label: 'Public Profile', desc: 'Allow others to see your showcase' }
            ].map(setting => (
